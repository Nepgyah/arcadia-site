...
export default function Footer() {
    return (
        <footer className="gradient-primary-vertical">
            <div id="wrapper">
                <div id="cta" className="border-radius-md shadow">
                    <img id="queens" src="/footer/queens.png" alt="" />

                    <div className="text">
                        <div>
                            <p>Join Today</p>
                            <h2>Find Your Place In Arcadia</h2>
                            <p>Discover new experiences, connect with fellow fans, and explore everything Arcadia has to offer.</p>
                            <a className="fit-content" href="https://arcadia-platform.vercel.app/auth" target='_blank'>
                ...
                <div id="footer">
                    <div id="overview">
                        <img src="/logos/arcadia-logo.png" className="m-b-md" alt="" />
